...
class INAP_ajax{
	...
	?>
			...
			inap_loading();
			$("#"+where).load("<?php echo $home;?>/wp-content/plugins<?php inap_the_base();?>/inap-get-info.php<?php echo $inapsuffix; ?>",
	...
	?>
			...
			d.getElementById('submit_form_'+id).innerHTML = $.ajax({
			type: "POST",
	...
	?>
			...
			$("#"+inap_loop).load("<?php echo $home;?>/wp-content/plugins<?php inap_the_base();?>/inap-get-info.php<?php echo $inapsuffix; ?>",
